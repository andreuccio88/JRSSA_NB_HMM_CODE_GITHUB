# Population universe and objective HMD support screening.
# Selection uses only pre-specified institutional scope and data-coverage criteria;
# no fitted mortality quantity enters population inclusion.
