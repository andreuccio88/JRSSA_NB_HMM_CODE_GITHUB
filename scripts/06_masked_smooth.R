...
scfg <- smooth_config(cfg, "masked_1925_1935")
scfg$mask_window <- list(enabled = TRUE, start = as.integer(cfg$analysis$target_mask_start), end = as.integer(cfg$analysis$target_mask_end))
...
summarise_smooth_masked(fit, pack, scfg$output_dir)
